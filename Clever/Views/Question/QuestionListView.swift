        ...
        ScrollView {
            VStack(spacing: 10) {
                ...
                VStack(alignment: .leading) {
                    ...
                    .toggleStyle(SwitchToggleStyle(tint: .luckypoint))
...
//    }
    ...
    private var selectFilesButton: some View {
        ...
        .uploadButton(backgroundColor: allFiles ? .gray : Color("Purple Background"), textColor: allFiles ? .white : .luckypoint)
    ...
    private var askQuestionButton: some View {
        ...
        .uploadButton(backgroundColor: courseViewModel.isLoadingQuestions || question.isEmpty ? .gray : .luckypoint, textColor: .white)
        .fontWeight(.medium)
